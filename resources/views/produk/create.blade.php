...
<div class="container create-product-container">
    <div class="create-product-card">
        <div class="create-product-header">
            <h4><i class="fa-solid fa-circle-plus me-2" style="color: #be123c;"></i> Tambah Produk</h4>
            <p>Tambahkan koleksi sepatu baru ke dalam katalog butik</p>
        </div>
